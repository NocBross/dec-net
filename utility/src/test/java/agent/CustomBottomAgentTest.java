...
public class CustomBottomAgentTest {
    ...
    private class TestAgent extends CustomBottomAgent {
        ...
        public TestAgent(CustomAgent parent, AgentID ID, String logFilePath, String logID) throws Exception {
    ...
    public void test() {
        try {
            String logID = "CustomBottomAgent";
            ...
            TestAgent agent = new TestAgent(parent, AgentID.CLIENT_AGENT, path, logID);
