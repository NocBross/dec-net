...
public class RegisterRequestControllerTest {
    ...
    public void test() {
        try {
            ...
            Assert.assertEquals(ServerStatusCodes.REGISTER_CORRECT, requestController.receiveResult(errorReport
                    .getMessage()));
            ...
            Assert.assertEquals(ServerStatusCodes.REGISTER_CORRECT, requestController.receiveResult(report
                    .getMessage()));
